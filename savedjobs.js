...
let savedJob=document.getElementById("saved-container-list")
...
function savedJob(jobsArray){
    for(i=0;i<jobsArray.length;i++){
        console.log(jobsArray[i]);
        const li=document.createElement("li")
        li.classList.add("saved-container-list")
        li.innerHTML=
        `<article>
 ...
 job.addEventListener("click",()=>{
    window.location.assign("./savedjobs.html")
